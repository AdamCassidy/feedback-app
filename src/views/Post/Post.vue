...
<v-container>
    ...
    <v-row>
        <v-col>
            <v-progress-circular v-if="loading && (post === undefined || post === null)" :size="50" indeterminate color="primary"></v-progress-circular>
        </v-col>
    </v-row>
        ...
        <v-col>
            <v-card>
                ...
                post.context
                        ...
                        <v-img style="margin: 15px" max-height="400" contain :src="post.imageURL"></v-img>
                        <v-divider></v-divider>
