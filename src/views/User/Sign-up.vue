                            ...
                            <form @submit.prevent="onSignUp">
                                <v-row>
                                    <v-col>
                                        ...
                                        <v-text-field v-model="confirmPassword" label="Confirm Password" type="password" :rules="[comparePasswords]"></v-text-field>
                                        <v-row cols="12">
                                            <v-col xs="5" sm="4" lg="3">
                                                <v-avatar size="200px">
                                                    <img v-if="image != null && image != undefined" :src="imageURL" />
